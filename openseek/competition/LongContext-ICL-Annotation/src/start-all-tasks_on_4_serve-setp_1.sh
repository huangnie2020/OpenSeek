...
if [ -n "$pids" ]; then
    ...
    export SERVE_BASE_URL="http://localhost:2026/v1"
    nohup python $dir/main_batch.py --task_id=[1,2] --task_step=1 > output1_12.log 2>&1 &

    export SERVE_BASE_URL="http://localhost:2027/v1"
    nohup python $dir/main_batch.py --task_id=[3,4] --task_step=1 > output1_34.log 2>&1 &

    export SERVE_BASE_URL="http://localhost:2028/v1"
    nohup python $dir/main_batch.py --task_id=[5,6] --task_step=1 > output1_56.log 2>&1 &

    export SERVE_BASE_URL="http://localhost:2029/v1"
    nohup python $dir/main_batch.py --task_id=[7,8] --task_step=1 > output1_78.log 2>&1 &
