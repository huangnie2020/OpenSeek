...
ASCEND_RT_VISIBLE_DEVICES=0 VLLM_PLUGINS=fl flagscale serve qwen3_s2_0 --config $dir/llm_config_s2_0.yaml
ASCEND_RT_VISIBLE_DEVICES=1 VLLM_PLUGINS=fl flagscale serve qwen3_s2_1 --config $dir/llm_config_s2_1.yaml
